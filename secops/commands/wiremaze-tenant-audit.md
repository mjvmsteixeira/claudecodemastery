---
description: Audita o isolamento multi-tenant de um cliente Wiremaze específico. Aplica CTRL-W-T-001..016 e produz relatório formal.
argument-hint: <nome-municipio-ou-tenant-uuid>
---

Auditoria de isolamento multi-tenant para o cliente: **$ARGUMENTS**

Activa a skill `wiremaze-tenant-isolation` e o subagent `wiremaze-tenant-01`.
...
7. Se houver não-conformidade crítica, marca-a no topo do relatório com escalada automática ao Coordenador SecOps Wiremaze.
