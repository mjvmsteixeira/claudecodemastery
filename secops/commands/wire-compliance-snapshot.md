...
Activa a skill `wire-compliance-provider` e o subagent `wire-compliance-01`.
...
6. Gera DOCX formal via Cowork `ai-rep-01` em `/shared/reports/output/wire-compliance-snapshot-<YYYY-Qn>.docx`.
