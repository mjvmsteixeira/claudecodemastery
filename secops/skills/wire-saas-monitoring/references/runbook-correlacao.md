...
> Template referenciado pela skill `wire-saas-monitoring`. Heurísticas operacionais para
...
- `/wire-saas-health` exibe estado especial "deploy in progress" e suprime warnings.
...
T+5s    /wire-saas-health auto-invocado pelo subagent wire-monitor-01
...
Diariamente às 09:00 UTC `/wire-saas-health --daily`:
...
`/wire-saas-health --quality-audit` mensal verifica:
