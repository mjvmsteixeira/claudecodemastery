...
> Template referenciado pela skill `wire-saas-monitoring`. Baseado em Zabbix 6.4+ LTS template
...
`/wire-saas-health` como "monitorização não-conforme".
...
`/wire-saas-health --audit-zabbix` reporta:
