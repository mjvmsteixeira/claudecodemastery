...
> Template referenciado pela skill `wire-saas-monitoring`. Baseado em Wazuh 4.7+ rule syntax,
...
**Group-by hint:** Para correlation operacional, agregar por `tenant_id` quando presente, depois por `dst_user`. Wire-monitor-01 usa este pattern em `/wire-saas-health`.

## Block 2 — RLS / Tenant Isolation (100020-100029)

```xml
<group name="wire-tenant-isolation,multi_tenant,">
