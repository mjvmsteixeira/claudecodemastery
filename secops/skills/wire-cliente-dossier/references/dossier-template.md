...
> Template referenciado pela skill `wire-cliente-dossier`. Consolida a relação completa Wire ↔
...
Gerado por `/wire-cliente-dossier <municipio>`.
...
- **Auditoria isolamento (último score):** [X]/80 ([%]) — ver wire-tenant-isolation
...
### Lado Wire
- **Gestor de conta:** [NOME]
- **SecOps de referência:** wire-monitor-01 / [HUMANO de plantão]
- **DPO Wire:** [NOME]
