...
> Template referenciado pela skill `wire-release-safety`. Baseado em práticas de progressive
...
sem este plano aprovado por `/wire-release-gate`.
...
**Aprovação gate:** [/wire-release-gate ref]
...
Cada fase regista em `~/.wire/log/canary-<product>-<version>.log`:
