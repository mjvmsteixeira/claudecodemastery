...
> Template referenciado pela skill `wire-release-safety`. Workflow de rollback Capistrano com
...
- [ ] WIRE_APPROVE=N2 (cross-tenant) ou N3 (irreversível) presente
...
Comunicação via skill `wire-ir-multitenant` (`distribuicao-classificacao.md`).
