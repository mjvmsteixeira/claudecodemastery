...
> Template referenciado pela skill `wire-compliance-provider`. Baseado em RGPD Art. 35, Diretrizes
...
> - **Organizacionais:** code review obrigatório para alterações a tabelas multi-tenant; checklist `wire-tenant-isolation` em cada release; CTRL-W-T-* auditado trimestralmente.
